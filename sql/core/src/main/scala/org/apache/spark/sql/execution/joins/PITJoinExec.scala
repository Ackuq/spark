...
import org.apache.spark.sql.catalyst.plans.{JoinType, PIT, PITOuter}
...
case class PITJoinExec(
  ...
  val returnNulls: Boolean = joinType match {
    case PIT => false
    case PITOuter => true
  ...
  override protected def withNewChildrenInternal(
    newLeft: SparkPlan, newRight: SparkPlan): PITJoinExec =
  ...
  override def outputOrdering: Seq[SortOrder] = {
    ...
    getKeyOrdering(leftKeys, left.outputOrdering)
  }
